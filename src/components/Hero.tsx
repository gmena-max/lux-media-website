  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto text-center px-6 pt-28 pb-16 md:py-24">
        ...
        >
          <span className="text-white">Tus clientes están en redes</span>
          <br />
          <span
          ...
          >
            Nosotros los convertimos en ventas
          </span>
        </h1>
        ...
        >
          ...
          <Link
            href="/portafolio"
            onClick={() => trackEvent("cta_click", { event_label: "Hero - Ver resultados" })}
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-4">
          {[
            ...
            <span
              key={item}
              className="px-4 py-2 rounded-full text-sm text-gray-400"
              style={{
