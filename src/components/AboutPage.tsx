...
const team = [
  {
    ...
    initials: "JC",
    bio: "Dirige la producción audiovisual de Deporte+ en Teletica (500K televidentes/domingo) y la estrategia creativa de cada cuenta. 5 años en producción de contenido para marcas de salud, deportes y tecnología.",
  ...
  },
  {
    ...
    initials: "FC",
    bio: "Responsable de toda la producción audiovisual, edición y diseño gráfico. Desde reels hasta aftermovies de eventos, Fernando ejecuta la visión creativa con equipo profesional.",
    linkedin: "",
    instagram: "",
  },
];
