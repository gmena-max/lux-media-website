...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://facebook.com/luxmedia",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/luxmedia",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/luxmedia",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          ...
          >
            ...
            <span>WhatsApp: +506 8905-2828</span>
          </a>
          ...
          >
            ...
            <span>Email: hola@luxmedia.cr</span>
          </a>
        </motion.div>
